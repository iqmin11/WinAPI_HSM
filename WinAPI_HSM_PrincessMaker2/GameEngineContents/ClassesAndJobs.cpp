...
void ClassesAndJobs::SetOliveObj(int _SuccessStart, int _SuccessEnd, int _FailStart, int _FailEnd, int _DontStart, int _DontEnd, const float4& _Pos)
{
	...
	OliveObject->CreateAnimation({ .AnimationName = StopState, .ImageName = Object_Name, .Start = OliveSuccessFrameStart , .End = OliveSuccessFrameStart,.InterTime = 0.2f });
}
...
void ClassesAndJobs::SetObj1(PM2RenderOrder _Order, int _Start, int _End, const float4& _Pos)
{
	...
	Object1->CreateAnimation({ .AnimationName = "Stop", .ImageName = Object_Name, .Start = Object1FrameStart , .End = Object1FrameStart ,.InterTime = 0.2f });
}
...
void ClassesAndJobs::SetObj2(PM2RenderOrder _Order, int _Start, int _End, const float4& _Pos)
{
	...
	Object2->CreateAnimation({ .AnimationName = "Stop", .ImageName = Object_Name, .Start = Object2FrameStart , .End = Object2FrameStart ,.InterTime = 0.2f });
}
...
void ClassesAndJobs::SetObj3(PM2RenderOrder _Order, int _Start, int _End, const float4& _Pos)
{
	...
	Object3->CreateAnimation({ .AnimationName = "Stop", .ImageName = Object_Name, .Start = Object3FrameStart , .End = Object3FrameStart ,.InterTime = 0.2f });
}
...
void ClassesAndJobs::SetObj4(PM2RenderOrder _Order, int _Start, int _End, const float4& _Pos)
{
	...
	Object4->CreateAnimation({ .AnimationName = "Stop", .ImageName = Object_Name, .Start = Object4FrameStart , .End = Object4FrameStart,.InterTime = 0.2f });
}
...
void ClassesAndJobs::SetObj5(PM2RenderOrder _Order, int _Start, int _End, const float4& _Pos)
{
	...
	Object5->CreateAnimation({ .AnimationName = "Stop", .ImageName = Object_Name, .Start = Object5FrameStart , .End = Object5FrameStart ,.InterTime = 0.2f });
}

void ClassesAndJobs::PlayObj()
{
	if (nullptr != OliveObject)
	{
		OliveObject->ChangeAnimation(SuccessState);
...
void ClassesAndJobs::StopObj()
{
	if (nullptr != OliveObject)
	{
		OliveObject->ChangeAnimation("Stop");
	}

	if (nullptr != Object1)
	{
		Object1->ChangeAnimation("Stop");
	}

	if (nullptr != Object2)
	{
		Object2->ChangeAnimation("Stop");
	}

	if (nullptr != Object3)
	{
		Object3->ChangeAnimation("Stop");
	}

	if (nullptr != Object4)
	{
		Object4->ChangeAnimation("Stop");
	}

	if (nullptr != Object5)
	{
		Object5->ChangeAnimation("Stop");
	}
}
