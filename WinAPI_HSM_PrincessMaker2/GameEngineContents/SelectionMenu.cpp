...
void SelectionMenu::SetButtonString(int _RenderOrder, int _ButtonIndex, const std::string_view& _Text)
{
	...
	StringRenders[_ButtonIndex]->SetText(_Text, 18, "굴림", TextAlign::Left, RGB(255, 255, 255), SelectButtons[_ButtonIndex]->GetScale());
	...
	StringShadowRenders[_ButtonIndex]->SetText(_Text, 18, "굴림", TextAlign::Left, RGB(0, 0, 0), SelectButtons[_ButtonIndex]->GetScale());
	...
	StringHoverRenders[_ButtonIndex]->SetText(_Text, 18, "굴림", TextAlign::Left, RGB(236, 152, 132), SelectButtons[_ButtonIndex]->GetScale());
