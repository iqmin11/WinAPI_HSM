...
void SelectionMenu::SetSelection(int _Count, int _Order)
{
	HilightSelections.resize(_Count);
	...
	{
		SelectionCollisions[i] = CreateCollision(_Order + 1);
