...
void TheologyClass::Start()
{
	...
	GetStatusVarianceMin().SetStatus({.Intelligence = 1, .Faith = 1, .Stress = 0,.MagicDefense = 0 });
	GetStatusVarianceMax().SetStatus({ .Intelligence = 1, .Faith = 2,.Stress = 1, .MagicDefense = 1 });
	SetPayGold(-40);
